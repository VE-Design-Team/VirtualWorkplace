...
var tableDaata = [];
 ...
 function pdfTestform() {
  goAbbey();
  var doc = new jsPDF('l', 'mm', 'a4');
  var col = [["URN", "Family Name", "Given Name", "Date of Birth", "Gender",]]; // rows = []
  ...
  var header = function header(data) {
    ...
    doc.text("Pain Test Form", data.settings.margin.left, 10);
  };
...
function checkInputTestform() {
  var myTab = document.getElementsByClassName('testform'),
      _length = myTab.length;
