...
function login() {
 ...
 function route() {
  if (document.getElementById("customCheck1").checked && document.getElementById("customCheck2").checked) window.location.href = './patientrecord';else //alert("Please read all messages to proceed")
