...
<div class="content">
    ...
    <div class="container p-5 mb-5 page rounded-lg">
        ...
        <div class="btn-group-vertical w-100 p-0 bg-white shadow rounded"><a
                class="btn btn-outline-secondary border-light text-left p-4" href="./foodrecord"> Food & Fluids</a><a
                class="btn btn-outline-secondary border-light text-left p-4" href="./continence"> Continence</a><a
                class="btn btn-outline-secondary border-light text-left p-4" href="./personalcare"> Personal
                Care</a><a class="btn btn-outline-secondary border-light text-left p-4" href="./abbeyscale"> Abbey
                Scale</a></div>
        <div class="push"></div>
    </div>
</div>
